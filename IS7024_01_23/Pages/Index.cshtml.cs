    ...
    public class IndexModel : PageModel
    {
        ...
        private async Task<WeatherData> GetWeatherData()
        {
            ...
            return await Task.Run(async () =>
            {
                ...
                Task<HttpResponseMessage> weatherTask = client.GetAsync("https://api.weatherbit.io/v2.0/forecast/daily?city=Cincinnati,OH&key=OYKRBWxnitTDzh8ovGqci8Ilgwr6l3gqIZ20QBHU");
